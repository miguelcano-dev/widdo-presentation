...
// ============================================================
// DECK WIDDO CLUBS USA (ventas a clubes) — PDF rasterizado 2x
// Uso: node decks/clubes/generate-deck-clubs-usa.js
// ============================================================

const INPUT = path.join(__dirname, 'deck-widdo-clubs-usa.html');
const OUTPUT = path.join(__dirname, 'deck-widdo-clubs-usa.pdf');
...
<html><head><style>
  * { margin: 0; padding: 0; }
  ...
  @media print { body { margin: 0; } }
    ...
    console.log(`Clubs USA Deck PDF generated: deck-widdo-clubs-usa.pdf (${slideCount} slides, ${sizeMb} MB, 2x JPEG 90%)`);
  } finally {
    await browser.close();
  }
})();
