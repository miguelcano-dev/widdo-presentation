...
(async () => {
  ...
  const htmlPath = path.join(__dirname, 'deck-usa-widdo.html');
...
<html><head><style>
  * { margin: 0; padding: 0; }
  ...
  await pdfPage.pdf({
    path: path.join(__dirname, 'deck-usa-widdo.pdf'),
    width: '1280px',
    height: '720px',
  ...
  await browser.close();
  console.log('USA Deck PDF generated: deck-usa-widdo.pdf (2x JPEG 90%)');
})();
