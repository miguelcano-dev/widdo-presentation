...
Clave: es:widdo-cuenta-multiples-roles-deportivos
ID observado: 27
Idioma: es
Título real: Una Cuenta, Múltiples Roles: Cómo Widdo Simplifica tu Vida Deportiva
URL: https://widdo.co/es/blog/widdo-cuenta-multiples-roles-deportivos
Resumen: Eres entrenador, padre y jugador amateur. ¿Tres apps? ¿Tres cuentas? No. Descubre cómo Widdo unifica toda tu vida deportiva en un solo lugar.
Secciones del contenido: El Problema de la Fragmentación; La Visión de Widdo: Una Identidad, Múltiples Roles; Como Entrenador; Como Padre; Como Jugador; Como Dueño de Club; Cómo Funciona en la Práctica; Tu Historia Deportiva es Tuya; Beneficios para Todos

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Entrenador de básquet, padre de nadadora y jugador de tenis; misma persona.
Dirección de arte del tema: Secuencia de tres vistas reales: abrir el selector, elegir rol y entrar al espacio correspondiente. Misma persona y misma cuenta, con etiquetas Entrenador, Padre y Jugador.
...
Gancho exacto, solo versión B: «Una cuenta. Todos tus roles.»
Alt propuesto para A/C, revisar según resultado: Una misma persona alterna entre sus roles de entrenador, padre y jugador.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/es/widdo-cuenta-multiples-roles-deportivos-es-portada.webp",
  "hook": "images/es/widdo-cuenta-multiples-roles-deportivos-es-gancho.webp",
  "og": "images/es/widdo-cuenta-multiples-roles-deportivos-es-og.jpg",
  "master": "masters/es/widdo-cuenta-multiples-roles-deportivos-es.png",
  "sidecar": "metadata/es/widdo-cuenta-multiples-roles-deportivos-es.json"
}
