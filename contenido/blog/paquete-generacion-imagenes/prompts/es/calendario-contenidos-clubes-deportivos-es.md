...
Clave: es:calendario-contenidos-clubes-deportivos
ID observado: 26
Idioma: es
Título real: Calendario de Contenidos para Clubes: Qué Publicar Cada Mes del Año
URL: https://widdo.co/es/blog/calendario-contenidos-clubes-deportivos
Resumen: Nunca más te quedes sin ideas. Un calendario completo con qué publicar en cada época del año para mantener activas tus redes sociales.
Secciones del contenido: Enero - Nuevos Comienzos; Febrero - Amor por el Deporte; Marzo - Día de la Mujer; Abril - Semana Santa y Vacaciones; Mayo - Mes de las Madres; Junio - Mitad de Año; Julio-Agosto - Vacaciones Largas; Septiembre - Amor y Amistad; Octubre - Halloween; Noviembre - Mes del Niño (Colombia); Diciembre - Cierre de Año; Contenido Evergreen (Todo el Año)

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Calendario de club multideportivo: natación, voleibol y artes marciales.
Dirección de arte del tema: Calendario editorial mensual legible con miniaturas de entrenamiento, testimonio, inscripción y torneo, más una pequeña franja de meses del año. Debe verse qué publicar, no solamente fechas.
...
Gancho exacto, solo versión B: «Tu próximo post empieza aquí»
Alt propuesto para A/C, revisar según resultado: Calendario editorial con miniaturas de entrenamientos, testimonios y eventos de distintos deportes.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/es/calendario-contenidos-clubes-deportivos-es-portada.webp",
  "hook": "images/es/calendario-contenidos-clubes-deportivos-es-gancho.webp",
  "og": "images/es/calendario-contenidos-clubes-deportivos-es-og.jpg",
  "master": "masters/es/calendario-contenidos-clubes-deportivos-es.png",
  "sidecar": "metadata/es/calendario-contenidos-clubes-deportivos-es.json"
}
