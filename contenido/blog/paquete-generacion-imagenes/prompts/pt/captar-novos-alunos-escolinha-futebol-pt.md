...
Clave: pt:captar-novos-alunos-escolinha-futebol
ID observado: 42
Idioma: pt
Título real: Como captar novos alunos para a escolinha sem depender só da indicação
URL: https://widdo.co/pt/blog/captar-novos-alunos-escolinha-futebol
Resumen: Indicação é o melhor canal que uma escolinha tem, e também o mais imprevisível. Veja como construir captação que não depende de sorte no mês.
Secciones del contenido: Antes de divulgar, saiba quem você atende; A aula experimental é o seu produto de entrada; Onde a família procura; Organize a indicação em vez de esperar por ela; Os primeiros trinta dias decidem o resto; Não capte mais rápido do que consegue reter; O que acompanhar todo mês

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Brasil, futebol de bairro conforme slug e conteúdo; captação local.
Dirección de arte del tema: Mapa del barrio conectado a Aula experimental → Comparecimento → Matrícula; escena de bienvenida a una familia en la cancha. Representar captación local y seguimiento, no crecimiento abstracto.
...
Gancho exacto, solo versión B: «Da aula experimental à matrícula.»
Alt propuesto para A/C, revisar según resultado: Professor recebe uma família em uma aula experimental de futebol no bairro.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/pt/captar-novos-alunos-escolinha-futebol-pt-capa.webp",
  "hook": "images/pt/captar-novos-alunos-escolinha-futebol-pt-chamada.webp",
  "og": "images/pt/captar-novos-alunos-escolinha-futebol-pt-og.jpg",
  "master": "masters/pt/captar-novos-alunos-escolinha-futebol-pt.png",
  "sidecar": "metadata/pt/captar-novos-alunos-escolinha-futebol-pt.json"
}
