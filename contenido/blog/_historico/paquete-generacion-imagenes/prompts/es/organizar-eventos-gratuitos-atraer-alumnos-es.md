...
Clave: es:organizar-eventos-gratuitos-atraer-alumnos
ID observado: 28
Idioma: es
Título real: Cómo Organizar Eventos Gratuitos que Atraigan Nuevos Alumnos
URL: https://widdo.co/es/blog/organizar-eventos-gratuitos-atraer-alumnos
Resumen: Los eventos de puertas abiertas, clínicas deportivas y torneos relámpago son excelentes para captar nuevos alumnos. Aprende a organizarlos efectivamente.
Secciones del contenido: Tipos de Eventos que Funcionan; 1. Clases de Prueba Abiertas; 2. Puertas Abiertas; 3. Clínicas Deportivas; 4. Torneos Relámpago; Cómo Organizarlos Efectivamente; Antes del Evento; Durante el Evento; Después del Evento; Métricas de Éxito

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Puertas abiertas de básquet y voleibol, dos zonas diferenciadas sin mezclar reglas.
Dirección de arte del tema: Jornada de puertas abiertas: entrenador recibiendo a una familia, niños participando en una clase de prueba y mesa de inscripción. Debe comunicar captación mediante una experiencia gratuita.
...
Gancho exacto, solo versión B: «La primera clase cuenta»
Alt propuesto para A/C, revisar según resultado: Entrenador recibe a una familia en una jornada abierta de una escuela multideportiva.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/es/organizar-eventos-gratuitos-atraer-alumnos-es-portada.webp",
  "hook": "images/es/organizar-eventos-gratuitos-atraer-alumnos-es-gancho.webp",
  "og": "images/es/organizar-eventos-gratuitos-atraer-alumnos-es-og.jpg",
  "master": "masters/es/organizar-eventos-gratuitos-atraer-alumnos-es.png",
  "sidecar": "metadata/es/organizar-eventos-gratuitos-atraer-alumnos-es.json"
}
