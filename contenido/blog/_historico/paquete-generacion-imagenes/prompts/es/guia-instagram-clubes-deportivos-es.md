...
Clave: es:guia-instagram-clubes-deportivos
ID observado: 20
Idioma: es
Título real: Guía Completa de Instagram para Clubes Deportivos: Del Cero al Engagement
URL: https://widdo.co/es/blog/guia-instagram-clubes-deportivos
Resumen: Todo lo que necesitas saber para manejar el Instagram de tu club deportivo como un profesional: tipos de contenido, horarios y estrategias que funcionan.
Secciones del contenido: Configura Tu Perfil Correctamente; Los 5 Tipos de Contenido que Funcionan; 1. Entrenamientos en Acción; 2. Transformaciones y Logros; 3. Detrás de Cámaras; 4. Testimonios; 5. Información Útil; Cuándo Publicar; Hashtags Efectivos; Stories vs. Feed

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Contenido de básquet y natación en cuadrícula; referencia editorial a Instagram.
Dirección de arte del tema: Perfil demostrativo de una escuela deportiva con bio, destacados y una cuadrícula que muestre entrenamientos, logros y testimonios. Mantener el logo como apoyo, no como imagen completa.
...
Gancho exacto, solo versión B: «Que tu club se vea»
Alt propuesto para A/C, revisar según resultado: Perfil editorial de una escuela deportiva con fotos de entrenamientos, logros y familias.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/es/guia-instagram-clubes-deportivos-es-portada.webp",
  "hook": "images/es/guia-instagram-clubes-deportivos-es-gancho.webp",
  "og": "images/es/guia-instagram-clubes-deportivos-es-og.jpg",
  "master": "masters/es/guia-instagram-clubes-deportivos-es.png",
  "sidecar": "metadata/es/guia-instagram-clubes-deportivos-es.json"
}
