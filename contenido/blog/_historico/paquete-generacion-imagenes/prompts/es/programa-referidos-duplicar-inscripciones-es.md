...
Clave: es:programa-referidos-duplicar-inscripciones
ID observado: 24
Idioma: es
Título real: Cómo Crear un Programa de Referidos que Duplique tus Inscripciones
URL: https://widdo.co/es/blog/programa-referidos-duplicar-inscripciones
Resumen: El boca a boca sigue siendo el marketing más efectivo. Aprende a sistematizar las recomendaciones y convertirlas en un motor de crecimiento.
Secciones del contenido: Por Qué Funcionan los Referidos; Estructura de un Programa de Referidos Efectivo; 1. Define el Incentivo; 2. Hazlo Simple; 3. Premia a Ambos; 4. Comunícalo Constantemente; Momentos Clave para Pedir Referidos; Cómo Medir el Éxito; Ejemplo de Programa

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Artes marciales en dojo; bienvenida y referidos, sin cinturones o uniformes incoherentes.
Dirección de arte del tema: Una familia del club presenta a otra al entrenador; complementar con el recorrido Invitar → Clase de prueba → Inscripción y beneficio para ambas familias, sin prometer duplicación garantizada.
...
Gancho exacto, solo versión B: «Una familia trae a otra»
Alt propuesto para A/C, revisar según resultado: Una familia presenta a otra al entrenador durante una clase de prueba de artes marciales.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/es/programa-referidos-duplicar-inscripciones-es-portada.webp",
  "hook": "images/es/programa-referidos-duplicar-inscripciones-es-gancho.webp",
  "og": "images/es/programa-referidos-duplicar-inscripciones-es-og.jpg",
  "master": "masters/es/programa-referidos-duplicar-inscripciones-es.png",
  "sidecar": "metadata/es/programa-referidos-duplicar-inscripciones-es.json"
}
