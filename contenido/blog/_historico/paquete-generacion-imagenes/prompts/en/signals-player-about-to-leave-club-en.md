...
Clave: en:signals-player-about-to-leave-club
ID observado: 36
Idioma: en
Título real: The Signals a Player Is About to Leave Your Club
URL: https://widdo.co/en/blog/signals-player-about-to-leave-club
Resumen: Players almost never quit suddenly. They drift for weeks first, and every one of those weeks leaves a trace you can see.
Secciones del contenido: Signal 1 — Attendance drifts before anything else; Signal 2 — Payment goes from automatic to manual; Signal 3 — The parent goes quiet; Signal 4 — The sibling leaves first; Signal 5 — They skip the thing that is meant to be fun; Why nobody acts on any of this; What to actually do when a signal fires; The point is the timing, not the tool

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): USA youth ice hockey; fuera del hielo para conversación, equipo deportivo correcto.
Dirección de arte del tema: Línea temporal de varias semanas de un jugador ficticio: menos asistencias, pago tardío y menor comunicación. Terminar en contacto del entrenador con la familia, no en una predicción garantizada.
...
Gancho exacto, solo versión B: «Notice before they leave.»
Alt propuesto para A/C, revisar según resultado: A youth hockey coach reviews missed practices before speaking with a player and family.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/en/signals-player-about-to-leave-club-en-cover.webp",
  "hook": "images/en/signals-player-about-to-leave-club-en-hook.webp",
  "og": "images/en/signals-player-about-to-leave-club-en-og.jpg",
  "master": "masters/en/signals-player-about-to-leave-club-en.png",
  "sidecar": "metadata/en/signals-player-about-to-leave-club-en.json"
}
