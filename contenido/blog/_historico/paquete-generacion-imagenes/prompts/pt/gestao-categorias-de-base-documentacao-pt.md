...
Clave: pt:gestao-categorias-de-base-documentacao
ID observado: 44
Idioma: pt
Título real: Categorias de base: chamada, atestado e documentação em dia
URL: https://widdo.co/pt/blog/gestao-categorias-de-base-documentacao
Resumen: A parte chata da gestão de base é também a que protege o clube. Um sistema simples para chamada, atestado e autorização que os professores realmente usam.
Secciones del contenido: A regra dos quinze segundos para a chamada; Para que serve a chamada depois de feita; A pasta mínima de cada aluno; Registre a ocorrência no dia em que ela acontece; Um calendário anual resolve o resto; Comece por uma turma

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Brasil, basquete de base; documentos fictícios e chamada.
Dirección de arte del tema: Ficha demostrativa del alumno con Chamada, Contato de emergência, Atestado y Autorização, estados vigentes/pendientes y fecha de revisión. Añadir al profesor en la cancha; documentos e información ficticios.
...
Gancho exacto, solo versión B: «Tudo em dia para treinar.»
Alt propuesto para A/C, revisar según resultado: Professor organiza chamada e documentos de alunos junto a uma quadra de basquete.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/pt/gestao-categorias-de-base-documentacao-pt-capa.webp",
  "hook": "images/pt/gestao-categorias-de-base-documentacao-pt-chamada.webp",
  "og": "images/pt/gestao-categorias-de-base-documentacao-pt-og.jpg",
  "master": "masters/pt/gestao-categorias-de-base-documentacao-pt.png",
  "sidecar": "metadata/pt/gestao-categorias-de-base-documentacao-pt.json"
}
