...
Clave: pt:reduzir-inadimplencia-mensalidades-escolinha
ID observado: 39
Idioma: pt
Título real: Como reduzir a inadimplência de mensalidades na sua escolinha
URL: https://widdo.co/pt/blog/reduzir-inadimplencia-mensalidades-escolinha
Resumen: Na maioria das escolinhas o problema não é o responsável que não quer pagar: é um processo em que esquecer dá menos trabalho do que pagar. Veja como virar esse jogo.
Secciones del contenido: Conte quantos passos o responsável precisa dar; Quatro mudanças que mexem no número; 1. A cobrança tem que existir antes do vencimento; 2. Automatize o lembrete, não a relação; 3. Deixe pagar na hora em que a pessoa pensou em pagar; 4. Deixe o saldo visível para a família, sempre; O que dá para esperar; Separe atraso de dificuldade; Pare de tratar comprovante como registro; A parte que ninguém comenta; Como o Widdo entra nisso

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Brasil, natação; recepção de escolinha e organização de cobrança.
Dirección de arte del tema: Mensalidade de un alumno ficticio con vencimiento, recordatorio y estado Em aberto / Pago en un teléfono; acompañar con la revisión del coordinador. Textos en portugués.
...
Gancho exacto, solo versión B: «Mensalidade sem correria.»
Alt propuesto para A/C, revisar según resultado: Coordenadora de uma escola de natação organiza mensalidades e lembretes em um celular.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/pt/reduzir-inadimplencia-mensalidades-escolinha-pt-capa.webp",
  "hook": "images/pt/reduzir-inadimplencia-mensalidades-escolinha-pt-chamada.webp",
  "og": "images/pt/reduzir-inadimplencia-mensalidades-escolinha-pt-og.jpg",
  "master": "masters/pt/reduzir-inadimplencia-mensalidades-escolinha-pt.png",
  "sidecar": "metadata/pt/reduzir-inadimplencia-mensalidades-escolinha-pt.json"
}
