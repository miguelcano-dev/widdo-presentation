...
Clave: pt:evasao-de-alunos-escolinha-sinais
ID observado: 41
Idioma: pt
Título real: Evasão de alunos: os sinais que aparecem semanas antes da desistência
URL: https://widdo.co/pt/blog/evasao-de-alunos-escolinha-sinais
Resumen: Aluno quase nunca sai de uma hora para outra. Ele se afasta por semanas antes, e cada uma dessas semanas deixa um rastro que dá para enxergar.
Secciones del contenido: 1. Faltas seguidas; 2. O responsável fica em silêncio; 3. O comportamento de pagamento muda; 4. Uniforme, horário e logística começam a escorregar; 5. O aluno some da vida do grupo; A janela é mais curta do que parece; O que fazer nessa janela; Os dois momentos de maior risco; Converse com quem já saiu; Isso precisa ser tarefa de alguém

CONTEXTO DEPORTIVO OBLIGATORIO (prevalece sobre cualquier ejemplo del brief anterior): Brasil, vôlei juvenil; foco em acompanhamento e acolhimento.
Dirección de arte del tema: Calendario de faltas consecutivas y señales de menor participación de un alumno ficticio, junto a una conversación del profesor con la familia. Centrar el gráfico en semanas previas a la salida.
...
Gancho exacto, solo versión B: «Perceba antes da despedida.»
Alt propuesto para A/C, revisar según resultado: Professor de vôlei observa faltas recorrentes e conversa com a família de um aluno.

ARCHIVOS DE SALIDA EXACTOS:
{
  "cover": "images/pt/evasao-de-alunos-escolinha-sinais-pt-capa.webp",
  "hook": "images/pt/evasao-de-alunos-escolinha-sinais-pt-chamada.webp",
  "og": "images/pt/evasao-de-alunos-escolinha-sinais-pt-og.jpg",
  "master": "masters/pt/evasao-de-alunos-escolinha-sinais-pt.png",
  "sidecar": "metadata/pt/evasao-de-alunos-escolinha-sinais-pt.json"
}
